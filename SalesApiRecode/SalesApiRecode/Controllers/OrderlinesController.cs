...
namespace SalesApiRecode.Controllers
{
    ...
    public class OrderlinesController : ControllerBase
    {
        ...
        public OrderlinesController(SalesApiRecodeContext context)
        {
            _context = context;
        }
        ...
        private async Task RecalculateOrderTotal(int id)
        {
            ...
            var total = (from o in _context.Orders
                         ...
                         where o.Id == id //this is the Orderline.OrderId
                         select new
                         {
            ...
            // Update the order total. ! means order is not null
            order!.Total = total;
            // Save changes
        ...
        public async Task<IActionResult> PutOrderline(int id, Orderline orderline)
        {
            ...
            try
            {
                ...
                // Must add the recalculation AFTER the save - Pass in the OrderId FK
        ...
        public async Task<ActionResult<Orderline>> PostOrderline(Orderline orderline)
        {
          if (_context.Orderlines == null)
          {
              return Problem("Entity set 'SalesApiRecodeContext.Orderlines'  is null.");
          }
